...
const ViewCardModal = ({
    ...
    const handleRequestDeleteComment = (commentId: number, authorName: string) => {
        requestDeleteComment(commentId, authorName)
    }
    ...
    return (
        <>
                                                ...
                                                displayedComments.map((comment) => (
                                                    <div key={comment.id} className={styles.commentItem}>
                                                        <div className={styles.commentHeader}>
                                                            ...
                                                            {(currentUser && comment.author.name === currentUser.name) || userRole?.isOwner ? (
                                                                <button
            ...
            <CommentDeleteModal
                ...
                commentAuthor={commentToDelete?.authorName}
            />
        </>
    )
}
